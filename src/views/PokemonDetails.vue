          ...
          <v-row class="px-4">
            <v-col cols="6">
              ...
              <v-col
                align="left"
                class="mt-4"
                style="width: 400px; height:350px; background: grey"
              >
                Stats
              </v-col>
            </v-col>
            ...
            <v-col cols="6" class="text-left">
                ...
                <v-row>
                  <v-col class="attribute-title pl-4"
                    ...
                    <v-col class="pa-0 my-3">
                      ...
                      <div>
                        <span class="pr-2"
                          ><v-icon>mdi-gender-male</v-icon></span
                        >
              ...
              <v-col>
                ...
                <span
                  :class="`type ${type.type.name} mr-2 py-1 text-center type-style`"
              ...
              <v-col> 
                ...
                <span
                  :class="`type ${weakness.name} mr-2 mb-2 py-1 text-center type-style`"
